...
const Instructions = () => {
    return(
        <div>
            <h2>Instructions</h2>
            <ol>
                <li>Beat the eggs: In a bowl, beat the eggs with a pinch of salt and pepper until they are well mixed.<br></br>You can add a tablespoon of water or milk for a fluffier texture.</li>
